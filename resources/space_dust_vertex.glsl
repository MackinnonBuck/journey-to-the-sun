...
void main()
{
	...
	wrappedPos.x += cnoise(vec4(instancePos.xyz * 10000, time * 0.25)) * 0.25;
	wrappedPos.y += cnoise(vec4(instancePos.zyx * 10000, time * 0.25 + 1000)) * 0.25;
	wrappedPos.z += cnoise(vec4(instancePos.yxz * 10000, time * 0.25 + 2000)) * 0.25;
