...
void main()
{
	...
	wrappedPos.x += cnoise(vec4(instancePos.xyz * 10000, time * 0.025)) * 5;
	wrappedPos.y += cnoise(vec4(instancePos.zyx * 10000, time * 0.025 + 1000)) * 5;
	wrappedPos.z += cnoise(vec4(instancePos.yxz * 10000, time * 0.025 + 2000)) * 5;
