...
void CameraActor::addKeyframes()
{
    ...
    addPositionKeyframes(0, {
        ...
        Keyframe({992.0000, -0.4808 + 8.0f}, {744.6667, -0.4808}, {1320.6666, -0.4808}),
        Keyframe({1978.0000, 56.8935 + 8.0f}, {1649.3334, 56.8935}, {2306.6667, 56.8935}),
	});
    ...
    addPositionKeyframes(2, {
        ...
        Keyframe({992.0000, 0.6348 + 9.0f}, {744.6667, 0.6348}, {1320.6666, 0.6348}),
        Keyframe({1978.0000, 2.0911 + 9.0f}, {1649.3334, 2.0911}, {2306.6667, 2.0911}),
	});
}
